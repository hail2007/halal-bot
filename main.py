...
if __name__ == '__main__':
    ...
    # Удаляем вебхук и ставим новый
    bot.remove_webhook()
    
    # Получаем PORT от Railway (обязательно!)
    port = int(os.environ.get('PORT', 8080))
    
    # Устанавливаем вебхук (Railway даёт свой URL)
    ...
    try:
        ...
        print("⚠️ Проверь что в настройках Railway указан PUBLIC_URL")
